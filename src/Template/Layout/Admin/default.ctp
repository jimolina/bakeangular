...
?>
<!DOCTYPE html>
<html ng-app="adminBase" ng-controller="generalController" data-ng-init="colorSet('<?= $colorSet["colorSet"] ?>')">
<head>
    <?= $this->Html->charset() ?>
    ...
    <?//= $this->Html->css("color-set-{{ layout }}.css") ?>
    <?= $this->Html->css('admin.css') ?>
    <link rel="stylesheet" ng-href="/css/color-set-{{ layout }}.css?id=1.0.2">
...
<body class="container-fluid">
    <div ng-show="loadingPage">
        <?= $this->element('admin/spinner-grid'); ?>
    </div>
    <div class="general-container" style="display: none;">
